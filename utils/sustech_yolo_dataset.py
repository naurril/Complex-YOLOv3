...
import numpy as np
import random
from utils.sustech_dataset import SUSTechDataset
...
class SUSTechYOLODataset(SUSTechDataset):
...
class SUSTechYOLO2WayDataset(SUSTechDataset):
    ...
    def __getitem__(self, index):
        ...
        img_file = os.path.join(self.image_path, '%06d.jpg' % sample_id)
